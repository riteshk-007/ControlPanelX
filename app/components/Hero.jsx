      ...
      <div className="py-12 md:py-20 px-4 md:px-8">
        <div className="w-full md:p-5 mx-auto flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <p className="text-lg mb-6">
              Users will have access to their website&apos;s admin dashboard
              link, user details such as login ID and password, as well as
              cPanel links. To access cPanel credentials, users need to obtain
